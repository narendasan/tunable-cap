...
from generative_policy_proposals._replay_buffer import ReplayBuffer
...
def optimize_policy(
    ...
    next_memories = [None] * envs.num_envs
    ...
    for global_step in range(args.total_timesteps):
        ...
        next_memories = list(next_memories)
        assert len(next_memories) == envs.num_envs
        assert len(actions) == envs.num_envs
